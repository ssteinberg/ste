...
/**
*	@brief	Defines a set of shader stages
*/
class pipeline_binding_stages_set {
private:
	boost::container::flat_set<ste_shader_stage> set;

public:
	pipeline_binding_stages_set() = default;
...
private:
	friend bool operator<=(const pipeline_binding_stages_set &lhs, const pipeline_binding_stages_set &rhs);
	friend bool operator<(const pipeline_binding_stages_set &lhs, const pipeline_binding_stages_set &rhs);
	friend bool operator>=(const pipeline_binding_stages_set &lhs, const pipeline_binding_stages_set &rhs);
	friend bool operator>(const pipeline_binding_stages_set &lhs, const pipeline_binding_stages_set &rhs);
	friend bool operator==(const pipeline_binding_stages_set &lhs, const pipeline_binding_stages_set &rhs);

	friend pipeline_binding_stages_set operator|(const pipeline_binding_stages_set &lhs, const pipeline_binding_stages_set &rhs);
	friend pipeline_binding_stages_set operator&(const pipeline_binding_stages_set &lhs, const pipeline_binding_stages_set &rhs);
	friend pipeline_binding_stages_set operator^(const pipeline_binding_stages_set &lhs, const pipeline_binding_stages_set &rhs);
};
...
*/
bool inline operator<=(const pipeline_binding_stages_set &lhs, const pipeline_binding_stages_set &rhs) {
	for (auto &b : lhs) {
		if (!rhs.exists(b))
			return false;
	}
...
*/
pipeline_binding_stages_set inline operator|(const pipeline_binding_stages_set &lhs, const pipeline_binding_stages_set &rhs) {
	pipeline_binding_stages_set ret = lhs;
...
*/
pipeline_binding_stages_set inline operator&(const pipeline_binding_stages_set &lhs, const pipeline_binding_stages_set &rhs) {
	pipeline_binding_stages_set ret;
	for (auto &s : lhs)
		if (rhs.exists(s))
			ret.insert(s);
	return ret;
