...
bool texture_cube_map_array::upload(const gli::texture_cube_array &texture, bool gm) {
	bool ret = true;
...
bool texture_cube_map_array::upload_layer(int layer, const gli::texture_cube &texture) {
	bool ret = true;
...
bool texture_cube_map_array::upload_face(CubeMapFace face, int layer, const gli::texture2d &texture) {
	// Index of max level
