...
class pixel_buffer_object : public buffer_object<Type, U> {
private:
...
public:
	pixel_buffer_object(pixel_buffer_object &&m) = default;
	pixel_buffer_object& operator=(pixel_buffer_object &&m) = default;
