...
ste::gl::device_pipeline_graphics text_manager::create_pipeline(const ste_context &ctx,
	...
	fb_layout.get()[0] = gl::clear_store(ctx.device().get_surface().surface_format(),
...
bool text_manager::update_pipeline_bindings(gl::command_recorder &recorder) {
