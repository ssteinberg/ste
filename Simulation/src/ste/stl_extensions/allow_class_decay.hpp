...
struct allow_class_decay_conversion_empty {};
...
template <
	...
	int Depth
>
struct allow_class_decay_conversion_recursive;

template <typename T>
decltype(T::_class_decay_conversion_only_const, std::true_type{}) _allows_decay(int);
template <typename T>
...
class recursive_class_decay_t : public allow_class_decay_conversion_recursive<
	CRTP,
	typename DecayT::_class_decay_conversion_decay_t,
	NextDecayT,
	DecayT::_class_decay_conversion_only_const && only_const,
	Depth + 1
> {};
template <typename CRTP, typename DecayT, typename NextDecayT, bool only_const, int Depth>
class recursive_class_decay_t<CRTP, DecayT, NextDecayT, only_const, Depth, false> : public allow_class_decay_conversion_empty {};

template <typename NextDecayT, int Depth>
struct class_recusive_decay_getter {
	template <typename T>
	auto& operator()(T&& t) {
		auto getter = class_recusive_decay_getter<typename NextDecayT::_class_decay_conversion_decay_t, Depth - 1>();
...
>
struct allow_class_decay_conversion_recursive : 
	public recursive_class_decay_t<CRTP, DecayT, NextDecayT, only_const, Depth, _detail::allow_recursive_decay<DecayT>::value>
{
	virtual ~allow_class_decay_conversion_recursive() noexcept {}
...
>
class allow_class_decay_conversion :
	public _detail::allow_class_decay_conversion_recursive<CRTP, DecayT, DecayT, only_const, 0>
{
public:
	virtual ~allow_class_decay_conversion() noexcept {}

	using _class_decay_conversion_decay_t = DecayT;
	static constexpr bool _class_decay_conversion_only_const = only_const;
};
...
template <
	...
	bool only_const = true
>
class allow_class_decay : public allow_class_decay_conversion<CRTP, DecayT, only_const> {
public:
	virtual ~allow_class_decay() noexcept {}
