...
private:
	...
	static StE::task_future_chain<void> load_texture(task_scheduler *sched,
	...
	static std::vector<StE::task_future_chain<void>> load_textures(task_scheduler* sched,
															 	   shapes_type &shapes,
...
public:
	static StE::task_future_chain<bool> load_model_task(const StEngineControl &context,
