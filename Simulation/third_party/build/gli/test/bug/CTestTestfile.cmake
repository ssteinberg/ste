...
elseif("${CTEST_CONFIGURATION_TYPE}" MATCHES "^([Mm][Ii][Nn][Ss][Ii][Zz][Ee][Rr][Ee][Ll])$")
  add_test(test-bug "C:/src/git/StE/Simulation/third_party/build/gli/test/bug/MinSizeRel/test-bug.exe")
elseif("${CTEST_CONFIGURATION_TYPE}" MATCHES "^([Rr][Ee][Ll][Ww][Ii][Tt][Hh][Dd][Ee][Bb][Ii][Nn][Ff][Oo])$")
  add_test(test-bug "C:/src/git/StE/Simulation/third_party/build/gli/test/bug/RelWithDebInfo/test-bug.exe")
else()
