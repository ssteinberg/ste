...
OutFile "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\${BUILDDIR}libjpeg-turbo-1.5.2-vc64.exe"
InstallDir ..\..\
...
!endif
	...
	SetOutPath $SYSDIR
!ifdef GCC
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\libturbojpeg.dll"
!else
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\${BUILDDIR}turbojpeg.dll"
!endif
...
!endif
!ifdef GCC
	File "/oname=libjpeg-62.dll" "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\sharedlib\libjpeg-*.dll"
!else
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\sharedlib\${BUILDDIR}jpeg62.dll"
!endif
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\sharedlib\${BUILDDIR}cjpeg.exe"
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\sharedlib\${BUILDDIR}djpeg.exe"
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\sharedlib\${BUILDDIR}jpegtran.exe"
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\${BUILDDIR}tjbench.exe"
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\${BUILDDIR}rdjpgcom.exe"
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\${BUILDDIR}wrjpgcom.exe"
	SetOutPath $INSTDIR\lib
!ifdef GCC
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\libturbojpeg.dll.a"
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\libturbojpeg.a"
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\sharedlib\libjpeg.dll.a"
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\libjpeg.a"
!else
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\${BUILDDIR}turbojpeg.lib"
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\${BUILDDIR}turbojpeg-static.lib"
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\sharedlib\${BUILDDIR}jpeg.lib"
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\${BUILDDIR}jpeg-static.lib"
!endif
!ifdef JAVA
	SetOutPath $INSTDIR\classes
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\java\${BUILDDIR}turbojpeg.jar"
!endif
	SetOutPath $INSTDIR\include
	File "D:/src/git/StE/Simulation/third_party/build/libjpeg-turbo64\jconfig.h"
