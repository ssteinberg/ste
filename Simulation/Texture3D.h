...
public:
	...
	Texture3D(const gli::texture3d &t, bool generate_mipmaps = false) : texture_mipmapped(t.format(), t.extent(), generate_mipmaps ? calculate_mipmap_max_level(t.extent()) + 1 : t.levels()) {
