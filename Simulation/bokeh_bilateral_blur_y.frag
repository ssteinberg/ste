...
void main() {
	vec4 l7 = texelFetch(tex, ivec2(gl_FragCoord.xy) - ivec2(0,8), 0);
	vec4 l6 = texelFetch(tex, ivec2(gl_FragCoord.xy) - ivec2(0,7), 0);
	vec4 l5 = texelFetch(tex, ivec2(gl_FragCoord.xy) - ivec2(0,6), 0);
	vec4 l4 = texelFetch(tex, ivec2(gl_FragCoord.xy) - ivec2(0,5), 0);
	...
	vec4 r4 = texelFetch(tex, ivec2(gl_FragCoord.xy) + ivec2(0,5), 0);
	vec4 r5 = texelFetch(tex, ivec2(gl_FragCoord.xy) + ivec2(0,6), 0);
	vec4 r6 = texelFetch(tex, ivec2(gl_FragCoord.xy) + ivec2(0,7), 0);
	vec4 r7 = texelFetch(tex, ivec2(gl_FragCoord.xy) + ivec2(0,8), 0);
